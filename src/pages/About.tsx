  ...
  return (
    <Box>
      <BoxContent header={'Новый проект'}>
        ...
        />
        <InputField placeholder="Краткая информация о проекте" />
        <InputField placeholder="Описание проблемы, решению/снижению которой посвящен проект" />
        <InputField placeholder="Основные целевые группы, на которые направлен проект" />
        <WrapperButtons>
